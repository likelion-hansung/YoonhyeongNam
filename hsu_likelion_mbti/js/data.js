...
const qnaList = [
    {
        ...
        a: [
            {
                answer: "a. 준비 다했는데... 오늘 시간 되는 친구 없나?? ",
                type: "EI",
            },
            {
                answer: "b. 오히려 좋아 밀린 드라마 정주행해야지",
                type: "EI",
            },
        ],
    },
    ...
    {
        q: "팀플을 같이하게 된 친구들과 친해지려 같이 상상파크에 갔다. 이때 당신은? ",
        a: [
            {
                answer: "a. 새로운 대화의 주제를 꺼내면서 열심히 질문한다.",
                type: "EI",
            },
            {
                answer: "b. 친구들의 질문에 열심히 대답한다.",
                type: "EI",
            },
        ],
    },
    ...
    {
        q: "같이 밥을 먹기로 한 친구들의 수업이 늦게 끝나게 되어 혼자 밥을 먹게 되었다.",
        a: [
            {
                answer: "a. 혼밥은 역시 학식당이지. 소금구이 덮밥 있으면 좋겠당ㅎㅎ",
                type: "EI",
            },
            {
                answer: "b. 좀만 참았다가 집가서 먹어야겠다!",
                type: "EI",
            },
        ],
    },
    ...
    {
        q:"오랜만에 대면수업을 하러 학교에 왔다! 어, 공학관이 어디더라?",
        a: [
            {
                answer: "공학관 갈 때마다 숨이 찼던 기억이.. 저 언덕 위에 있을듯!",
                type: "SN",
            },
            {
                answer: "b. 뭐 학교도 오랜만에 온김에 산책이나 할겸 다 둘러보면서 찾아야겠다~!",
                type: "SN",
            },
        ],
    },
    ...
    {
        q: "한성대에 들어온 당신 ! 한성대 마스코트인 상상부기가 반겨주고 있다 이때 당신이 드는 생각은 ?", 
        a: [
            {
                answer: "a. 귀엽다, 거북이다, 동그랗다, 파랗다, 누가 만들었지, 성별이 뭐지",
                type: "SN",
            },
            {
                answer: "b. 이름이 왜 상상부기지?, 뽀로로랑 친할 것 같다, 아 거북이랑 펭귄이랑은 안친해지나?",
                type: "SN",
            },
        ],
    },

    {
        ...
        a: [
            {
                answer: "a. 백종원님의 떡볶이 레시피 검색! 아 근데 재료가 하나 없네.. 담에 만들어야겠다.. ",
                type: "SN",
            },
            {
                answer: "b. 저번에 백종원님 티비 프로에서 어떻게 하는지 다 봐놨지!! 음 설탕이 없네 대신 꿀 넣어야겠당",
                type: "SN",
            },
        ],
    },

    {
        ...
        a: [
            {
                answer: "a. 자가키트 해봤어? 교수님한테 말씀부터 드려! 결석처리 될라 ㅠㅠ",
                type: "TF",
            },
            {
                answer: "b. 몸 많이 안좋아 ..? 코로나 아니었음 좋겠다.. 일단 수업 걱정하지말구 푹 쉬어. 수업은 걱정마 내꺼 필기 보여줄게! ",
                type: "TF",
            },
        ],
    },
    ...
    {
        q: "친구가 오래 사귀던 애인과 헤어져서 많이 힘들어 한다. 이때 당신은?",
        a: [
            {
                answer: "a. 아이고.. 괜찮아..? 시간 좀 지나면 괜찮아질걸거야..! 시간이 약이래잖어..",
                type: "TF",
            },
            {
                answer: "b. 고생했어 그동안. 너무 힘들어하지마. 너가 최고야. 힘내자!!",
                type: "TF",
            },
        ],
    },

    {
        ...
        a: [
            {
                answer: "a. 갑자기?! 그거 구글링하면 복구하는 법 뜰거야 빨리 그것부터 찾아서 해봐... 어카냐..",
                type: "TF",
            },
            {
                answer: "b. 헐???? 빨리 다시 켜봐! 제발 자동 백업 되어 있어라.. 어떡해..... 너 그거 하루종일 했잖아..",
                type: "TF",
            },
        ],
    },
    ...
    {
        q: "교수님이 과제를 등록하셨다. 이때 당신은?",
        a: [
            {
                answer: "a. 일요일까지? 일단 플래너에 마감 날짜 적어야겠다. 수요일부터 강의 들어야지. 아 이것도 적어둬야겠다.",
                type: "JP",
            },
            {
                answer: "b. 일요일까지라고? 절대 안잊어버려야지. 토욜에 무조건 낸다.",
                type: "JP",
            },
        ],
    },

    {
        ...
        a: [
            {
                answer: "a. 어우 어지러.. 스타동이랑 와글즈 합치고 6으로 나누면.. 지금 미리 단톡에 보내두고 빨리 자야겠다",
                type: "JP",
            },
            {
                answer: "b. 아 피곤하다.. 하 돈계산은.. 내일 해야지.. ",
                type: "JP",
            },
        ],
    },

    {
        ...
        a: [
            {
                answer: "a. 아오 삭신이야.. 짐부터 풀어놔야겠다..",
                type: "JP",
            },
            {
                answer: "b. 몰라몰라 피곤해 삭신이 쑤신다.. 일단 자야지..",
                type: "JP",
            },
        ],
    },
