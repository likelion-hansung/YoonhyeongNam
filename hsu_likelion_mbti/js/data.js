...
const qnaList = [
...

    {
        ...
        a: [
            {
                answer: "에잇 딴 애들한테 연락해봐야겠다. 여보세요? 너 학교야? 밥 드실?",
                type: "EI",
            },
            {
                answer: "포장해갈까..? 그냥 참고 집에 가서 먹어야겠다!",
                type: "EI",
            },
        ],
    },
    ...
    {
        q:"내일 대면으로 중간고사를 보는 당신 ! 열심히 공부하고 쉬고 있는 도중 당신은 ?",
        a: [
            {
                answer: "교수님이 중요하다고 하신 것부터 봐야겠다.",
                type: "SN",
            },
            {
                answer: "아.. 이것도 나올 것  같고 저것도 나올거같은데.. 처음부터 다 봐야겠다!",
                type: "SN",
            },
        ],
    },
...

    {
        ...
        a: [
            ...
            {
                answer: "몸 많이 안좋아 ..? 일단 수업 걱정하지말구 푹 쉬어. 수업은 걱정마 내꺼 필기 보여줄게! ",
                type: "TF",
            },
        ],
    },

    {
        ...
        a: [
            {
                answer: "어디서 얼마주고 잘랐어? 근데 갑자기 왜 잘랐어?",
                type: "TF",
            },
            {
                answer: "무슨 일 있었어? 괜찮아??",
...

    {
        ...
        a: [
            {
                answer: "일요일까지라고? 오늘부터 나눠서 강의 들어야 할 수 있겠다.",
                type: "JP",
            },
            {
                answer: "일요일까지라고? 목요일쯤부터 하면 되겠지.",
                type: "JP",
            },
        ],
    },
